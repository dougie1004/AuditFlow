...
// Helper to generate generic scenarios spanning 2 years
// Total: 9 Areas * 10 Scenarios = 90 Base Scenarios
const generateScenarios = (): Scenario[] => {
  ...
  AUDIT_AREAS.forEach((area) => {
    for (let i = 1; i <= 10; i++) {
      ...
      // Removed manual 'isNew' flag here to ensure base scenarios are standard. 
      // 'isNew' will be reserved for AI-discovered scenarios during the demo.
      const isNew = false; 
      ...
      // Specific Scenarios (Base Violations)
