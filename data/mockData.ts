...
export const MOCK_CORP_CARD_TRANSACTIONS: CorpCardTransaction[] = [
    { id: 'TXN001', employee: { name: '김민준', id: 'E1023', homeAddress: '서울시 강남구 테헤란로 427', department: 'R&D', homeLocation: { lat: 37.508, lng: 127.056 } }, merchant: '강남면옥', location: { lat: 37.506, lng: 127.054, name: '강남면옥', address: '서울시 강남구 삼성동 119-17' }, amount: 58000, timestamp: '2023-11-18T20:30:00Z', category: '음식점', anomaly: '자택 근처 사용' },
    { id: 'TXN002', employee: { name: '김민준', id: 'E1023', homeAddress: '서울시 강남구 테헤란로 427', department: 'R&D', homeLocation: { lat: 37.508, lng: 127.056 } }, merchant: 'CGV 강남', location: { lat: 37.500, lng: 127.027, name: 'CGV 강남', address: '서울시 강남구 역삼동 814-6' }, amount: 32000, timestamp: '2023-11-18T22:15:00Z', category: '여가', anomaly: '주말/심야 사용' },
    { id: 'TXN003', employee: { name: '이서연', id: 'E2045', homeAddress: '경기도 성남시 분당구 판교역로 1', department: '마케팅', homeLocation: { lat: 37.394, lng: 127.111 } }, merchant: '골프존파크 판교', location: { lat: 37.395, lng: 127.112, name: '골프존파크', address: '경기도 성남시 분당구 삼평동 678' }, amount: 150000, timestamp: '2023-11-19T14:00:00Z', category: '접대', anomaly: null },
    { id: 'TXN004', employee: { name: '박도현', id: 'E3001', homeAddress: '서울시 마포구 월드컵북로 396', department: '영업', homeLocation: { lat: 37.570, lng: 126.890 } }, merchant: '상암 주유소', location: { lat: 37.575, lng: 126.892, name: '상암 주유소', address: '서울시 마포구 상암동 1591' }, amount: 70000, timestamp: '2023-11-17T23:50:00Z', category: '교통', anomaly: '주말/심야 사용' },
    { id: 'TXN005', employee: { name: '김민준', id: 'E1023', homeAddress: '서울시 강남구 테헤란로 427', department: 'R&D', homeLocation: { lat: 37.508, lng: 127.056 } }, merchant: '선릉 스타벅스', location: { lat: 37.505, lng: 127.049, name: '선릉 스타벅스', address: '서울시 강남구 테헤란로 326' }, amount: 12500, timestamp: '2023-11-19T10:10:00Z', category: '음료', anomaly: '자택 근처 사용' },
    { id: 'TXN006', employee: { name: '최지아', id: 'E3002', homeAddress: '서울시 서초구 신반포로 176', department: '영업', homeLocation: { lat: 37.505, lng: 127.000 } }, merchant: '하나일식', location: { lat: 37.504, lng: 127.004, name: '하나일식', address: '서울시 서초구 반포동 19-3' }, amount: 280000, timestamp: '2023-11-20T19:45:00Z', category: '접대', anomaly: null },
    { id: 'TXN007', employee: { name: '박도현', id: 'E3001', homeAddress: '서울시 마포구 월드컵북로 396', department: '영업', homeLocation: { lat: 37.570, lng: 126.890 } }, merchant: '락휴 노래타운', location: { lat: 37.555, lng: 126.923, name: '락휴 노래타운', address: '서울시 마포구 서교동 363-1' }, amount: 450000, timestamp: '2023-11-20T21:10:00Z', category: '유흥', anomaly: '유흥업소 사용 의심' },
    { id: 'TXN008', employee: { name: '박도현', id: 'E3001', homeAddress: '서울시 마포구 월드컵북로 396', department: '영업', homeLocation: { lat: 37.570, lng: 126.890 } }, merchant: '락휴 노래타운', location: { lat: 37.555, lng: 126.923, name: '락휴 노래타운', address: '서울시 마포구 서교동 363-1' }, amount: 450000, timestamp: '2023-11-20T21:20:00Z', category: '유흥', anomaly: '쪼개기 결제 의심' },
    { id: 'TXN009', employee: { name: '이서연', id: 'E2045', homeAddress: '경기도 성남시 분당구 판교역로 1', department: '마케팅', homeLocation: { lat: 37.394, lng: 127.111 } }, merchant: '온라인광고-페이스북', location: { lat: 37.395, lng: 127.112, name: '온라인', address: 'N/A' }, amount: 480000, timestamp: '2023-11-21T11:00:00Z', category: '광고', anomaly: null },
    { id: 'TXN010', employee: { name: '김민준', id: 'E1023', homeAddress: '서울시 강남구 테헤란로 427', department: 'R&D', homeLocation: { lat: 37.508, lng: 127.056 } }, merchant: 'AWS-서비스이용료', location: { lat: 37.506, lng: 127.054, name: '온라인', address: 'N/A' }, amount: 350000, timestamp: '2023-11-22T15:30:00Z', category: 'IT', anomaly: null },
];
