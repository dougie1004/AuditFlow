...
const AuditReport: React.FC = () => {
  ...
  return (
    <div className="h-full flex flex-col bg-slate-100 p-8 overflow-hidden">
      <div className="max-w-5xl mx-auto w-full flex-1 flex flex-col">
        ...
        {/* Paper View */}
        <div className="flex-1 bg-white shadow-lg rounded-xl overflow-y-auto p-12 border border-slate-200 print:shadow-none print:border-none">
          
          {/* Report Header */}
          <div className="border-b-2 border-slate-900 pb-8 mb-8 flex justify-between items-start">
            <div>
              <h1 className="text-4xl font-extrabold text-slate-900 tracking-tight mb-2">Internal Audit Report</h1>
              <p className="text-lg text-slate-600">내부 통제 및 컴플라이언스 진단 결과 보고서</p>
            </div>
                ...
                {CRITICAL_VIOLATIONS.map((violation, idx) => (
                  <div key={idx} className="border border-slate-200 rounded-lg p-5">
                     <h4 className="font-bold text-red-600 mb-2 flex items-center">
                        <span className="bg-red-100 px-2 py-0.5 rounded text-xs mr-2">{violation.riskLevel}</span>
                        {violation.controlPoint}
                     </h4>
            ...
            <section>
             ...
             <div className="mt-16 pt-8 border-t border-slate-200 flex justify-between">
                <div>
                   ...
                   <p className="text-lg font-script mt-4">AuditFlow AI System</p>
